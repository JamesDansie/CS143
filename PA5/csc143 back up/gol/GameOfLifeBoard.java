 ...
 *@author James Dansie
 *@version PA2 - GameOfLife GUI challenge
 */
public class GameOfLifeBoard extends javax.swing.JPanel{
    ...
    /**
     *This field is the running state of the animation
     */
    public boolean running;
    /**
     *This field keeps track of the number of generations per minute
     */
    public int gpm;
    /**
...
//         });
         ...
         */
        JButton b2 = new JButton("Start Animation");
        b2.addActionListener(new ActionListener(){
//            @Override
            public void actionPerformed(ActionEvent e){
                Thread thread1 = new Thread(new Runnable(){
                    public void run(){
                        if(board.running == true){
                            b2.setText("Start Animation");
                            board.running = false;
                        }else{
                            b2.setText("Stop Animation");
                            board.running = true;
                                while(board.running){
                                game.nextGeneration();
                                win.repaint();
                                board.pause(1000/(board.gpm/60));
                            }
                        }
                    }
                });
